...
<?php
	...
	if (isset($_POST['operator']))
	{
		...
		//Transaksi
		if ($_POST['operator'] == "simpan_transaksi") { input_transaksi(); }
	}
?>
    		...
    		<td width="80%" align="left" bgcolor="#FFFFFF">
            	<?php
					if (isset($_GET['page']))
					{
						...
						else if ($_GET['page'] == "simpan_transaksi") { require('transaksi/simpan_transaksi.php'); }
						else if ($_GET['page'] == "view_transaksi") { require('transaksi/view_transaksi.php'); }
						//Default
